document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (value && (type === 'tel' || name.includes('phone'))) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .then(function() {
                    ...
                    successMessage.style.cssText = 'background-color: #d4edda; color: #155724; padding: 1rem; border-radius: 4px; margin-top: 1rem;';
                ...
                .catch(function() {
                    ...
                    errorMessage.style.cssText = 'background-color: #f8d7da; color: #721c24; padding: 1rem; border-radius: 4px; margin-top: 1rem;';
    ...
    if (animatedElements.length > 0) {
        function isElementInViewport(el, offset) {
            ...
            const elementOffset = offset || 100;
            
            return rect.top <= windowHeight - elementOffset && rect.bottom >= 0;
        }
        ...
        styleElement.textContent = '.fade-in.visible, .fade-in-up.visible, .fade-in-left.visible, .fade-in-right.visible { opacity: 1 !important; transform: translate(0, 0) !important; }';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4bdcb5c8-692b-423f-9119-7186b7f6eacf',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4bdcb5c8-692b-423f-9119-7186b7f6eacf';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4bdcb5c8-692b-423f-9119-7186b7f6eacf';
